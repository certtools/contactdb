...
CREATE TABLE organisation (
    ...
    -- Link to the parent organisation. By default NULL
...
-- We assume the regular tags from the
-- RIPE DB such as "tech-c" or "abuse-c"
-- possible values: "abuse-c", "billing-c" , "admin-c"
-- TODO: define possible values for quality data: e.g. CISO, OT organizational contact, emergency number, 24/7 number, etc.
CREATE TYPE ROLETYPES AS ENUM ('tech-c', 'abuse-c', 'billing-c', 'admin-c', 'CISO', '24/7', 'private');

-- Roles serve as an m-n relationship between organisations and contacts
CREATE TABLE role (
    id SERIAL PRIMARY KEY,
    role_type ROLETYPES,
	-- first contact for escalation
    is_primary_contact BOOLEAN NOT NULL DEFAULT FALSE,
	-- if primary contact is not contactable secondary contact as escalation
	is_secondary_contact BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TYPE notification AS (
    ...
    sector VARCHAR(100), --what about sector? why not refering to sector table?
